					...
					<div class="tab-pane active">
						...
						/*<div class="col-lg-12">
							<table width="100%" class="table table-striped table-bordered">
								...
								<tbody>
								<?php $total_debet = 0; $total_kredit = 0; foreach ($neraca as $b)
								{
									echo '<tr>';
									echo '<td>' .$b->kode_akun. '</td>';
									echo '<td>' .$b->nama_akun. '</td>';
									echo '<td class="text-right">' .rupiah2($b->debet). '</td>';
									echo '<td class="text-right">' .rupiah2($b->kredit). '</td>';
									echo '</tr>';
									$total_debet += $b->debet;
								...
								echo '<td class="text-right">' .rupiah2($total_debet). '</td>';
								echo '<td class="text-right">' .rupiah2($total_kredit). '</td>';
								echo '</tr>'; ?>
								</tbody>
							</table>
						</div>*/ ?>
