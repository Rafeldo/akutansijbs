<section class="content-header">
	<div class="row">
		<div class="col-md-12"> <label class="label-header"><?=$judul?> - Periode : <?=$tmp_p?></label>
		</div>
	</div>
</section>
							...
							<div class="col-lg-12">
								<?php if(count($labarugi)>0)
								{
									...
									foreach ($labarugi as $b)
									{
										...
										if($lewat_pendapatan=="")
										{
											if($b->no_urut > 2) $lewat_pendapatan = "jumlah pendapatan";
										}
										...
										if($b->no_depan=="4" || $b->no_depan=="6")
										{
											echo '<td class="text-right"></td>';
											echo '<td class="text-right">'.number_format($b->amount, 2).'</td>'; $total_pendapatan += $b->amount;
										}
										else
										{
									...
									echo '</tr>'; $laba_rugi = $total_pendapatan - $total_beban;
									if($labarugi>0)
									{
										echo '<tr class="info">';
