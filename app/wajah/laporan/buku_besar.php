			...
			<div class="nav-tabs-custom">
				...
				<div class="tab-content">
					<div class="tab-pane active">
						...
						<div class="row">
							<div class="col-lg-12">
								<?php $tmp_kode_akun 	= ""; $tmp_saldo 		= 0; $tmp_saldo_all 	= 0; if(count($bb)>0)
								{
									foreach ($bb as $b)
									{
										if($tmp_kode_akun != $b->kode_akun)
										{
											...
											echo '<thead><tr>';
											echo '<th rowspan="2" width="10%">Tanggal</th>';
											echo '<th rowspan="2" width="10%">No Bukti</th>';
											echo '<th rowspan="2" width="25%">Keterangan</th>';
											echo '<th rowspan="2" width="5%">Ref</th>';
											echo '<th rowspan="2" width="12.5%">Debet</th>';
											echo '<th rowspan="2" width="12.5%">Kredit</th>';
											echo '<th colspan="2" width="12.5%" align="center">Saldo</th>';
											echo '<tr>';
											...
											echo '<td align="center">'.$b->no_jurnal.'</td>';
											if($b->uraian=="Saldo Awal")
											{
