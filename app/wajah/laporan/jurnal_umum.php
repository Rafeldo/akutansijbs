						...
						<div class="row">
							<div class="col-xs-12">
						 	 <h2 class="page-header">
						 		<i class="fa fa-globe"></i> PT. Jakarta Baru Cosmopolitan
		                     ...
		                     if(count($jurnal)>0)
		                     {
		                        ...
		                        foreach ($jurnal as $b)
		                        {
		                           ...
		                           echo '<td >'.$b->no_jurnal.'</td>';
											echo '<td align="center"><span class="label label-success">'.$b->tgl_jurnal.'</td>';

											echo '<td>'.$b->uraian.'</td>';
		                           echo '<td class="text-right">'.number_format($b->debet, 2).'</td>';
		                           echo '<td class="text-right">'.number_format($b->kredit, 2).'</td>';
		                           echo '</tr>'; $all_debet += $b->debet; $all_kredit += $b->kredit; $tmp_debet += $b->debet; $tmp_kredit += $b->kredit; $baris++;
		                        }
		                        if($baris>0)
		                        {
