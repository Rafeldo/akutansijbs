...
<section class="content"> <div class="row">
	<div class="col-lg-12">
		<?php if($errors!="") echo $errors; $display = ""; if($mobile==1) {$display = "hidden"; echo alert_php2('Peringatan.', 'danger', '<br/>Sangat disarankan menggunakan laptop atau pc untuk menginput saldo awal'); } echo alert_php2('Info', 'info', '. Untuk pertama kali menggunakan <b>Sistem Akuntansi</b> ini silahkan masukkan nilai saldo awal pada perusahaan Anda.', 't'); ?>
...
function simpan_saldo()
{
	...
	swal({
		title: "Saldo Awal", text: "Apa Anda yakin ingin menyimpan data saldo awal pada periode " + periode + "?",
		type: "warning",
