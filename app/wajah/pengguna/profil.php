...
<section class="content">
	<div class="row">
		<div class="col-lg-12"> <?php if($errors!=""){ echo $errors; } if(validation_errors() != false) {echo alert_php2('', 'validate', validation_errors()); } $tmp_id = md5($this->session->userdata($this->config->item('ses_id'))); ?>
