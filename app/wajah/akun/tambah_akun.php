				...
				<div class="box-header">
					...
					<form id="exmb" class="form-horizontal" autocomplete="off" method="post" action="<?=base_url()?>akun/tambah">
						<div class="form-group">
							...
							<div class="col-lg-4">
								<select class="form-control selectnot" data-validetta="required" name="tipe_akun" id="tipe_akun" data-placeholder="pilih tipe akun" onchange="js_get_kode_tipe_akun(this.value)">
									<option value=""></option>
