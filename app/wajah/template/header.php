			...
			<ul class="nav navbar-nav">
				<li class="dropdown user user-menu">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img src="<?=base_url('assets/dist/img/avatar5.png')?>" class="user-image" alt="User Image">
						<span class="hidden-xs kunci"><?php echo $this->session->userdata($this->config->item('ses_name'))!=""?$this->session->userdata($this->config->item('ses_name')):"Administrator"; ?></span>
					</a>
