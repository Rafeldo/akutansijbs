					...
					<div class="box-body">
						...
						<div class="col-md-2">
							<div class="form-group">
								...
								<input type="text" class="form-control" data-validetta="required" maxlength="40" name="no_jurnal" id="no_jurnal" value="<?=$header['no_jurnal']?>" onchange="form_input(true)" />
							</div>
						</div>
						<!---
						<div class="col-md-2">
						...
						<div class="col-md-3">
							...
							<label class="checkbox-inline">
								<input type="checkbox" name="set_uraian" value="A"><small>Set Deskripsi sebagai Uraian</small>
							</label>
						</div>
					-->
					</div>
						...
						<div class="col-lg-12">
							<table class="table nanda">
								...
								<?php $xx = 1; foreach ($detail as $d) {
									echo '<tr>';
										echo '<td width="10%"><span class="no-bukti">'.$header['no_jurnal'].'</span></td>';
										echo '<td width="30%"><select class="form-control selectnot" name="akun[]" id="akun'. $xx .'" data-placeholder="-- pilih akun --">';
